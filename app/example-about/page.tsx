...
export default function ExampleAboutPage() {
  ...
  return (
    <section className="bg-white flex-col font-[futura] pb-16 min-h-screen">
      <SecondaryNavbar />
      <div className="flex justify-center align-middle">
        <div className='mt-1 w-[85vw] h-[90vh] mx-auto bg-cover bg-center bg-[url("/header.avif")] mb-28' />
        <h1 className="m-auto absolute text-[#fd5948] self-center font-[futura-bold] text-[125px]">Ableton</h1>
      </div>
      <div className='w-[85%] md:w-1/2 mx-auto font-[futura-bold] text-black'>
      ...
      <div className="py-[8%] mt-24 relative flex-col w-screen h-[58.33333vw] ">
      ...
      <div className='w-[85%] md:w-1/2 mx-auto mt-24 mb-16 text-black'>
      ...
      <div className="py-[8%] mt-24 relative flex-col w-screen h-[75vw]">
      ...
      <div className='w-[85%] md:w-1/2 mx-auto mt-36'>
        <BoldText>
      ...
      <div className='bg-[url(/poster-meet-the-makers.avif)] w-[85%] h-[44.99591836734694vw] bg-cover bg-center mx-auto  mt-8 md:mt-36 bg-no-repeat' >
      </div>
      <div className='w-[85%] md:w-1/2 mx-auto mt-16 md:mt-36'>
        <BoldText>
      ...
      <div className='w-[85vw] h-[60vw] mx-auto flex-col md:mx-auto md:flex md:flex-row sm:align-middle mt-36 md:justify-center md:w-[80vw] md:h-[40vw]' >
        <div className='w-[85vw] h-[50vw] md:w-[40vw] md:h-[40vw] bg-[url("/photo-8.jpg")] bg-cover bg-no-repeat bg-center' />
        <div className='w-[85vw] h-[30vw] md:w-[40vw] md:h-[40vw] bg-[#b1c5ff]  flex items-center justify-items-center'>
