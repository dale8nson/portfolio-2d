...
export function SecondaryNavbar() {
  ...
  return (<Navbar theme={theme} className="flex z-50 bg-[#ffffffcc] align-middle mx-0 !my-0 p-6 opacity-2 marker:content-[none] [&_div]:flex [&_div]:justify-start [&_div]:mx-6 [&_div]:font-bold [&_div]:space-x-4 font-[futura] [&_a]:text-[14px] md:[&_div]:my-0 sticky top-0">
